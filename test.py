...
def first_part(N,P):
    ...
    return frequency_table, total_elements
...
if __name__ == "__main__":
    ...
    for i in range(0, 100):
        frequency_table, total_elements = first_part(N, P)
        if(chi_square_test(frequency_table, k, z_values, q_values, N, alpha) == 1): sootvet += 1
        else: nesootvet += 1

    print(sootvet, nesootvet)